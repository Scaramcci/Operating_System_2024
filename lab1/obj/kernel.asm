...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    80200632:	a0278793          	addi	a5,a5,-1534 # 80201030 <etext+0x600>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    8020068e:	9daa8a93          	addi	s5,s5,-1574 # 80201064 <etext+0x634>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
    ...
    80200696:	baeb8b93          	addi	s7,s7,-1106 # 80201240 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    ...
    802008ec:	77860613          	addi	a2,a2,1912 # 80201060 <etext+0x630>
    ...
    802008fe:	75660613          	addi	a2,a2,1878 # 80201050 <etext+0x620>
    ...
    80200910:	73c40413          	addi	s0,s0,1852 # 80201048 <etext+0x618>
    ...
    8020099a:	6b240413          	addi	s0,s0,1714 # 80201048 <etext+0x618>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    ...
    802009b0:	69da0a13          	addi	s4,s4,1693 # 80201049 <etext+0x619>
